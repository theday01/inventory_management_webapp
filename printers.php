...
<head>
    ...
    <title>الطابعات - Smart Shop</title>
...
<body class="bg-dark text-white font-sans h-screen flex overflow-hidden">
    ...
    <main class="flex-1 flex flex-col relative overflow-hidden">
        ...
        <header
            ...
            <h2 class="text-xl font-bold text-white">إعدادات الطابعات</h2>
                    ...
                    <section
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                                <div class="flex items-center gap-4">
                                    <span class="material-icons-round text-2xl text-accent">check_circle</span>
                                    <div>
                                        <h4 class="font-bold text-white">Epson TM-T88VI</h4>
                                        <p class="text-xs text-gray-400">طابعة الإيصالات الحرارية (الافتراضية)</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2">
                                    <button class="text-gray-400 hover:text-white"><span class="material-icons-round">settings</span></button>
                                </div>
                            </div>
                            <!-- Printer 2 -->
                             <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                                <div class="flex items-center gap-4">
                                     <span class="material-icons-round text-2xl text-gray-500">radio_button_unchecked</span>
                                    <div>
                                        <h4 class="font-bold text-white">HP LaserJet Pro M404dn</h4>
                                        <p class="text-xs text-gray-400">طابعة ليزر A4</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2">
                                     <button class="text-gray-400 hover:text-white"><span class="material-icons-round">settings</span></button>
                                    <button class="text-gray-400 hover:text-primary"><span class="material-icons-round">check_circle_outline</span></button>
                                </div>
                            </div>
                        </div>
                        
                        <div class="mt-6">
                             <button class="w-full bg-primary/10 hover:bg-primary/20 text-primary px-6 py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2">

...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Global Notification Sound (Existing Logic preserved)
            ...
            .then(data => {
                ...
                if (countElement) {
                    ...
                    if (data.unread_count > 0) {
                        countElement.classList.remove('bg-green-500'); countElement.classList.add('bg-red-500'); countElement.style.display = 'inline-flex';
                    } else {
                        countElement.classList.remove('bg-red-500'); countElement.classList.add('bg-green-500'); countElement.style.display = 'none';
                    }
                }
                if (countBadge) {
